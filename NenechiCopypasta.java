public class NenechiCopypasta{
    ...
    protected String configureVersion(String chooseVersion) throws NameException {
        setNeneName(neneVersionName(chooseVersion));
        if(!(chooseVersion.equals("short")||chooseVersion.equals("long")||chooseVersion.equals("alternate"))){
            throw new NameException("Select a valid input: shorter, longer or alternate");
        }
